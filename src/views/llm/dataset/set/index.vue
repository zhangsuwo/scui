  ...
  <el-container>
    <el-header>
      <div class="left-panel">
        <el-button type="primary" icon="el-icon-plus" @click="add">生成数据集</el-button>
    ...
    <el-main class="nopadding">
      <scTable ref="table" :data="tableData" row-key="id" stripe @selection-change="selectionChange">
        ...
        <el-table-column label="版本号" prop="label" width="150"></el-table-column>
        <el-table-column label="别名" prop="alias" width="200"></el-table-column>
        <el-table-column label="生成总数" prop="sort" width="80"></el-table-column>
        ...
        <el-table-column label="操作" fixed="right" align="right" width="170">
          <template #default="scope">
            <el-button-group>
              <el-button text type="primary" size="small" @click="table_show(scope.row, scope.$index)">执行</el-button>
              <el-button text type="primary" size="small" @click="table_edit(scope.row, scope.$index)">下载</el-button>
      ...
      tableData: [
        {
          ...
          status: '0',
          content: [
            { question: '通过指针变量 p 访问其成员变量 name，下面语法正确的是', anwser: 'A', explan: 'golang指针' },
            { question: '通过指针变量 p 访问其成员变量 name，下面语法正确的是', anwser: 'A', explan: 'golang指针' },
          ],
        },
        {
